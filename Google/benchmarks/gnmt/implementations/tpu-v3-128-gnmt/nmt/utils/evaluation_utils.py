...
def _clean(sentence, subword_option, lower_case):
  """Clean and handle BPE or SPM outputs and convert case if needed."""
  ...
  return sentence.lower() if lower_case else sentence
...
def _bleu(ref_file, trans_file, subword_option=None, lower_case=False):
  ...
  for references in zip(*reference_text):
    ...
    for reference in references:
      reference = _clean(reference, subword_option, lower_case=lower_case)
