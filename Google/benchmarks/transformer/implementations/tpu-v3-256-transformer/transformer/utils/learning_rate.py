...
def learning_rate_factor(name, step_num, hparams):
  ...
  elif name == "polynomial_warmup":
    return tf.minimum(1.0, (step_num / hparams.learning_rate_warmup_steps) ** 2)
...
def learning_rate_schedule(hparams):
  ...
  mlp_log.mlperf_print(
      key="opt_base_learning_rate", value=hparams.learning_rate_constant)
  mlp_log.mlperf_print(
...
def _global_step(hparams):  # pylint: disable=unused-argument
  """Return global step."""
