...
class ConditionalOptimizer(tf.train.Optimizer):
  ...
  def __init__(self, optimizer_name, lr, hparams, use_tpu=False):  # pylint: disable=super-init-not-called
    ...
    mlp_log.mlperf_print(
        key="opt_adam_beta_1", value=hparams.optimizer_adam_beta1)
    mlp_log.mlperf_print(
        key="opt_adam_beta_2", value=hparams.optimizer_adam_beta2)
    mlp_log.mlperf_print(
        key="opt_adam_epsilon", value=hparams.optimizer_adam_epsilon)
