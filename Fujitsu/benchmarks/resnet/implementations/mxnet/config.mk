...
USE_CUDA_PATH=$$CUDA_HOME
USE_LIBJPEG_TURBO=1
USE_LIBJPEG_TURBO_PATH=/usr
USE_NCCL=1
USE_NCCL_PATH=$$NCCL_HOME
USE_NVTX=1
#USE_TENSORRT=1
USE_TENSORRT=0
#ONNX_NAMESPACE=onnx
USE_DIST_KVSTORE=1
USE_HOROVOD=1
USE_MPI_PATH=$$OMPI_HOME
ADD_LDFLAGS=-L$$CUDNN_HOME/lib64 -L$$HOME/lib
ADD_CFLAGS=-I$$CUDNN_HOME/include -I$$HOME/include
