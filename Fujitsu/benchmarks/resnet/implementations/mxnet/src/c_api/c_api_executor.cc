...
int MXExecutorSimpleBind(SymbolHandle symbol_handle,
  ...
  // performance testing.
  dmlc::optional<bool> use_tensorrt = dmlc::GetEnv("MXNET_USE_TENSORRT", dmlc::optional<bool>());
  if (use_tensorrt.has_value() && use_tensorrt.value()) {
