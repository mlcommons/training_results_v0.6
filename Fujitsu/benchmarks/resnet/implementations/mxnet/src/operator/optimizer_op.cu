...
.set_attr<FCompute>("FCompute<gpu>", MultiSGDMomUpdateEx<gpu, type_identity, 4>);

NNVM_REGISTER_OP(multi_sgd_two_stage_lars_mom_update)
.set_attr<FCompute>("FCompute<gpu>", MultiSGDTwoStageLarsMomUpdate<gpu, type_identity, 4>);
NNVM_REGISTER_OP(multi_sgd_larc_mom_update)
.set_attr<FCompute>("FCompute<gpu>", MultiSGDLarcMomUpdate<gpu, type_identity, 3>);
...
.set_attr<FCompute>("FCompute<gpu>", MultiSGDMomUpdateEx<gpu, single_precision, 5>);

NNVM_REGISTER_OP(multi_mp_sgd_two_stage_lars_mom_update)
.set_attr<FCompute>("FCompute<gpu>", MultiSGDTwoStageLarsMomUpdate<gpu, single_precision, 5>);

NNVM_REGISTER_OP(multi_mp_sgd_larc_mom_update)
.set_attr<FCompute>("FCompute<gpu>", MultiSGDLarcMomUpdate<gpu, single_precision, 4>);
