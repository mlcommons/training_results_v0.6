...
.set_attr<nnvm::FInplaceOption>("FInplaceOption", [](const NodeAttrs& attrs){
  // input 3 (x input) can share its tensor with output 0 (dx).
  // input 0 (y gradient) could possibly share its tensor with output 0 (dx)
  //     based on the gpu implementation, but cpu gluon tests currently fail with this.
