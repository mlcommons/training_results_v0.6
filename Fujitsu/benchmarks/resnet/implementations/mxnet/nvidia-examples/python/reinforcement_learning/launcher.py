...
sys.path.append(os.path.join(os.environ['HOME'], "/opt/mxnet/3rdparty/dmlc-core/tracker"))
sys.path.append(os.path.join('/scratch', "/opt/mxnet/3rdparty/dmlc-core/tracker"))
