...
class TranslationTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--max-source-positions', default=256, type=int, metavar='N',
                            help='max number of tokens in the source sequence')
        parser.add_argument('--max-target-positions', default=256, type=int, metavar='N',
                            help='max number of tokens in the target sequence')
        parser.add_argument('--seq-len-multiple', default=1, type=int, metavar='N',
