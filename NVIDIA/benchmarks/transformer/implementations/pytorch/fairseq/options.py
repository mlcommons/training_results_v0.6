...
def add_perf_args(parser):
    ...
    group.add_argument('--softmax-type', default='default', metavar='SPLIT',
                       choices=['default', 'fast', 'masked_fast', 'masked_fast_bwd', 'fast_fill'],
                       help='Dot-product Attention softmax implementation type.')
    return group
